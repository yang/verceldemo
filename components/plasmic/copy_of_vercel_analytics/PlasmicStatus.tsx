...
import sty from "./PlasmicStatus.module.css"; // plasmic-import: bNHexnLPptchK/css
...
function PlasmicStatus__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(defaultcss.all, sty.box__nzpfq)} />

...
import Button from "../../Button"; // plasmic-import: 8czuQRxAQREBN/component
import MainScore from "../../MainScore"; // plasmic-import: b1vlgXoKN4IXE/component
import PerfScore from "../../PerfScore"; // plasmic-import: wsu9Jbk2t-1HP/component
import Separator from "../../Separator"; // plasmic-import: 2Z0w-3TeyDKh4/component
import LinkButton from "../../LinkButton"; // plasmic-import: i1DREZxYhATTM/component
import NumListItem from "../../NumListItem"; // plasmic-import: PRuvZwTRZwo1z/component
...
import sty from "./PlasmicAnalyticsPageContent.module.css"; // plasmic-import: 4o34z0-A3Cr0-W/css

import VercelLogoMarkIcon from "./icons/PlasmicIcon__VercelLogoMark"; // plasmic-import: Mp3zdd4eF-qVuI/icon
...
function PlasmicAnalyticsPageContent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(defaultcss.all, sty.box___9RcnO)}>
          <div
        ...
        <img
          ...
          src={
            hasVariant(globalVariants, "screen", "tablet")
              ? "/plasmic/copy_of_vercel_analytics/images/desktopScoreAnimation.png"
              : "/plasmic/copy_of_vercel_analytics/images/mobileScoreAnimation.png"
          }
        />

        <div className={classNames(defaultcss.all, sty.box__fBffJ)} />
      </div>
      ...
      >
        ...
        >
          <div className={classNames(defaultcss.all, sty.box__ckFOv)}>
            <div
              className={classNames(
                defaultcss.all,
                defaultcss.__wab_text,
            ...
            >
                ...
                >
                  {true ? (
                    <img
                      ...
                      src={
                        hasVariant(globalVariants, "screen", "tablet")
                          ? "/plasmic/copy_of_vercel_analytics/images/dashboard.png"
                          : "/plasmic/copy_of_vercel_analytics/images/dashboardMobilepng.png"
                      }
                    />
                  ) : null}
                </div>
              ...
              {(
                ...
                <img
                  ...
                  role={"img"}
                  src={"/plasmic/copy_of_vercel_analytics/images/dashboard.png"}
                />
              ) : null}
            </div>
          ) : null}
      ...
      >
        <div className={classNames(defaultcss.all, sty.box__sq3I)}>
          <div
            className={classNames(
              defaultcss.all,
              defaultcss.__wab_text,
          ...
          >
            <p.Stack
              ...
              className={classNames(defaultcss.all, sty.box__pMl4)}
            >
              <MainScore
              ...
              >
                <PerfScore
                  className={classNames("__wab_instance", sty.perfScore__o9T1I)}
                ...
                <PerfScore
                  className={classNames("__wab_instance", sty.perfScore__lyTdx)}
                  description={
                ...
                <PerfScore
                  className={classNames("__wab_instance", sty.perfScore__zhSe)}
      ...
      >
        <p.Stack
          ...
          className={classNames(defaultcss.all, sty.box___4WBmH)}
        >
          <div className={classNames(defaultcss.all, sty.box__vkReR)}>
            <div
              className={classNames(
                defaultcss.all,
                defaultcss.__wab_text,
            ...
            <p.Stack
              ...
              className={classNames(defaultcss.all, sty.box__qAnPr)}
            >
              <Button
              ...
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.box__jxQz7)}
                >
                  <VercelLogoMarkIcon
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.box__aL60P)}
            >
              <NumListItem
                className={classNames("__wab_instance", sty.numListItem__qsxEv)}
                slot={"1"}
              >
              ...
              <NumListItem
                className={classNames("__wab_instance", sty.numListItem__qvfRf)}
                slot={"2"}
              >
          ...
          >
            <img
              ...
              role={"img"}
              src={"/plasmic/copy_of_vercel_analytics/images/deployCard.png"}
            />
          </div>
        </p.Stack>
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__mZjwM)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__wwYzQ)}
          >
            <div
              className={classNames(
                defaultcss.all,

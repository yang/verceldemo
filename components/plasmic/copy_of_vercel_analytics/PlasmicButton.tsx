...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8czuQRxAQREBN/css
...
export type PlasmicButton__VariantsArgs = {
  type?: SingleChoiceArg<"secondary">;
};
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <p.PlasmicSlot
        defaultContents={"Get Your Score"}
        value={args.children}
